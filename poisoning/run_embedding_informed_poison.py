...
if __name__ == "__main__":
    ...
    save_dir = '/project2/shrikann_35/nmehlman/data/svpp-data/poison/informed_v2.0/id08616-100x-upsample' # Where to save poison and test data
